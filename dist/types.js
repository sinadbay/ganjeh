 ...
 */
export function describeUntrusted(value) {
...
export class WrongPassphraseError extends VaultError {
    ...
    exitCode = 2;
    constructor(message = 'passphrase incorrect, or the vault file has been modified') {
        super(message);
    }
}
...
export class InvalidNameError extends VaultError {
    ...
    exitCode = 1;
    constructor(name) {
        super(`invalid entry name ${describeUntrusted(name)}: names must match ` +
